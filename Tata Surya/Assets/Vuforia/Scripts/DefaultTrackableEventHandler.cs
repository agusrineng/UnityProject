    ...
    public class DefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
    {
        ...
        protected virtual void OnTrackingLost()
        {
            if (mTrackableBehaviour)
            {
                ...
                TextTargetName.GetComponent<Text>().text = "Arahkan Kamera ke Gambar";
                ButtonAction.gameObject.SetActive(false);
                TextDescription.gameObject.SetActive(false);
                TextDescription2.gameObject.SetActive(false);
                ButtonAksi.gameObject.SetActive(false);
                TextDescripsi.gameObject.SetActive(false);
                PanelDescropsi.gameObject.SetActive(false);
